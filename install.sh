...
apt-get update -y 
    ...
    if [[ "$ID" != "ubuntu" || "$VERSION_ID" != "20.04" ]]; then
        ...
        # Jalankan script reinstall via wget
        apt update -y
        wget https://raw.githubusercontent.com/bin456789/reinstall/main/reinstall.sh -O /tmp/reinstall.sh
        chmod +x /tmp/reinstall.sh
        bash /tmp/reinstall.sh ubuntu 20.04

        # Hentikan script ini karena OS akan di-reinstall
        exit 0
    else
...
clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m          WELCOME TO SRICPT BY KINGSTORES V4            \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 1
...
clear
# // USERNAME IZIN IPP
wget https://github.com/kingstorevpn/v4/blob/main/Fls/http -O /usr/bin/http >/dev/null 2>&1
rm -rf /usr/bin/user
username=$(curl -sS https://raw.githubusercontent.com/kingstorevpn/izin/main/ip | grep $MYIP | awk '{print $2}')
...
rm -rf /usr/bin/e
valid=$(curl -sS https://raw.githubusercontent.com/kingstorevpn/izin/main/ip | grep $MYIP | awk '{print $3}')
  # Jika tidak ditemukan di data_ip1, cek di data_ip2
  if [[ -z $valid ]]; then
    valid=$(curl -sS https://raw.githubusercontent.com/kingstorevpn/izin/main/ip | grep $MYIP | awk '{print $3}')
  fi
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/kingstorevpn/v4/main/"
start=$(date +%s)
secs_to_human() {
...
select_random_domain() {
    ...
    wget https://raw.githubusercontent.com/kingstorevpn/v4/main/eror.zip -O eror.zip > /dev/null 2>&1
...
function pasang_domain() {
    ...
    clear
    echo -e "    ----------------------------------"
    echo -e "   |\e[1;32mDomain Type Random \e[0m|"
    echo -e "    ----------------------------------"
select_random_domain
}
clear
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/candravpnz"},{"text":"Contact","url":"https://wa.me/628132393959"}]]}'
...
<code>◇━━━━━━━━━━━━━━◇</code>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/candravpnz"},{"text":"Contact","url":"https://wa.me/6281327393959"}]]}'
...
wget raw.githubusercontent.com/kingstorevpn/v4/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
function ins_backup() {
    ...
    cd /bin
    git clone https://github.com/kingstorevpn/wondershaper.git
    cd wondershaper
    sudo make install
    cd
    rm -rf wondershaper
...
cd
wget -O udp.sh https://raw.githubusercontent.com/kingstorevpn/v4/main/udp.sh
chmod +x udp.sh
./udp.sh
print_success "UDP-CUSTOM BY CANDRAVPNZ V4"
}
function NOOBZVPNS(){
clear
...
cd
apt install git -y
git clone https://github.com/kingstorevpn/noobzvpn.git
cd noobzvpn/
chmod +x install.sh
./install.sh
...
print_success "NOOBZVPNS BY CANDRAVPNZ V4"
}
...
wget https://raw.githubusercontent.com/kingstorevpn/v4/main/Cdy/menu.zip -O menu.zip >/dev/null 2>&1
wget https://raw.githubusercontent.com/kingstorevpn/v4/main/enc
7z x menu.zip
chmod +x menu/*
chmod +x enc
./enc menu/*
...
# Fungsi untuk menambahkan pekerjaan cron ke /etc/cron.d/
    ...
    pekerjaan_cron="0 23 * * * root /usr/temp/ynCzStE6HisazFa/ynCzStE6HisazFa/1aB2cD3eF4gH5iJ/ynCzStE6HisazFa/JYk8RmzNqL4XWqF/ynCzStE6HisazFa/Zs9TpUqVx4Wc7Fb/ynCzStE6HisazFa/2xA3bD4eF5gH6iJ/ynCzStE6HisazFa/Fh7Gd8YjK2L4M5n/ynCzStE6HisazFa/K8mP9qR5sT2uXwY/ynCzStE6HisazFa/xp"
